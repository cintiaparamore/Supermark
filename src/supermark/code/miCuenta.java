...
public class miCuenta {
	...
	public static void menuUsuario(Usuario user) {
		...
		case 5:
			...
			String sql_insertar = "INSERT INTO ventas (id_ventas, fecha, id_cliente, total_venta) VALUES (null, '"
					+ fechaventa + "'," + clicli + "," + totventa + ")";
			...
			try {
				...
				System.out.println("¡SU COMPRA SE HA REGISTADO CON ÉXITO!. "
						+ "SI DESEA VUELVA A SELECCIONAR PRODUCTOS Y CANTIDAD PARA REALIZAR OTRA COMPRA. ¡HASTA LA PROXIMA!");
			...
			// Inicializo el carrito para una nueva compra
